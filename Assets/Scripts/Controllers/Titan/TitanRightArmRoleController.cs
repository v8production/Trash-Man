...
namespace Titan
{
    ...
    public class TitanRightArmRoleController : MonoBehaviour, ITitanRoleController
    {
        ...
        public TitanRole Role => TitanRole.RightArm;
        ...
        public void TickRoleInput(float deltaTime)
        {
            ...
            float elbowInput = inputAggregationManager != null
                ? inputAggregationManager.Current.RightArmElbow
            ...
            rig.ApplyRightArm(shoulderPitch, shoulderYaw, elbowPitch);
        }
    }
}
